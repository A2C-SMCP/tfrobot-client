...
const mockResponses: Record<string, unknown> = {
  ...
  open_skills_root: '/tmp/skills',
  open_skill_folder: '/tmp/skills/demo-skill',
  open_skill_markdown_file: '/tmp/skills/demo-skill/SKILL.md',
  read_skill_markdown: '# Demo Skill\n\n- Runs local tasks\n- Uses `SKILL.md`',
  get_logs: [],
